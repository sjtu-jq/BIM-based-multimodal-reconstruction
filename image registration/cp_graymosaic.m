function Imosaic = cp_graymosaic(I1,I2,affmat,format)
% CP_MOSAIC
...
if strcmpi(format,'crop')
    validuv= [max(r1,c1) max(r1,c1); max(r1,c1)+r2 max(r1,c1)+c2];
elseif strcmpi(format,'loose')
