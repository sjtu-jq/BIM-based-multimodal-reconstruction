...
% [I1_gray, I2_gray, I1_rgb, I2_rgb, Filename1, Filename2, pathname] = cp_readImage(distort,inputpath,file1,file2)
...
% fprintf('\tsize of Image 1 is [%d¡Á%d]\n    size of Image 2 is [%d¡Á%d]\n',size(I1,1),size(I1,2),size(I2,1),size(I2,2));
